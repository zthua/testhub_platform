# Generated by Django 4.2.7 on 2026-01-26 07:26
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "task_name",
                    models.CharField(
                        help_text="相关任务的名称", max_length=200, verbose_name="任务名称"
                    ),
                ),
                (
                    "task_type",
                ...
                (
                    "recipient_info",
                    models.JSONField(help_text="接收通知的用户信息", verbose_name="收件人信息"),
                ),
                (
                    "webhook_bot_info",
                    models.JSONField(
                        blank=True, default=dict, null=True, verbose_name="Webhook机器人信息"
                    ),
                ),
                (
                    "notification_content",
                    models.TextField(help_text="发送的通知内容", verbose_name="通知内容"),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "task_type",
                    models.CharField(
                        choices=[("TEST_SUITE", "测试套件执行"), ("API_REQUEST", "API请求执行")],
                        max_length=20,
                        verbose_name="任务类型",
                    ),
                ),
